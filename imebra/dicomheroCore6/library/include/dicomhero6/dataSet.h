...
public:
    ...
    ///        "Implicit VR little endian") and default charset ("ISO_IR 6").
    ///
    ///////////////////////////////////////////////////////////////////////////////
    explicit DataSet();

    /// \brief Construct an empty DICOM dataset with charset "ISO_IR 6" and
    ...
    ///
    /// \warning [REQ_CONST_COPY_DOCUMENTATION] the value returned by this method
    ///          should not be modified and therefore should be assigned to
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    Image getImage(size_t frameNumber) const;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    Overlay getOverlay(size_t overlayNumber) const;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    Image getImageApplyModalityTransform(size_t frameNumber) const;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet getFunctionalGroupDataSet(size_t frameNumber) const;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet getSequenceItem(const TagId& tagId, size_t itemId) const;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    LUT getLUT(const TagId& tagId, size_t itemId) const;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    PatientName getPatientName(const TagId& tagId, size_t elementNumber) const;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    PatientName getPatientName(const TagId& tagId, size_t elementNumber, const PatientName& defaultValue) const;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    UnicodePatientName getUnicodePatientName(const TagId& tagId, size_t elementNumber) const;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    UnicodePatientName getUnicodePatientName(const TagId& tagId, size_t elementNumber, const UnicodePatientName& defaultValue) const;
#endif
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setImage(size_t frameNumber, const Image& image, imageQuality_t quality);

    DataSet& setOverlay(size_t overlayNumber, const Overlay& overlay);
    ...
    /// \return       the DataSet representing the added sequence item
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet appendSequenceItem(const TagId& tagId);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setInt64(const TagId& tagId, std::int64_t newValue, tagVR_t tagVR);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setInt32(const TagId& tagId, std::int32_t newValue, tagVR_t tagVR);

    /// \brief Deprecated. Use setInt32() instead.
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setSignedLong(const TagId& tagId, std::int32_t newValue, tagVR_t tagVR);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setInt64(const TagId& tagId, std::int64_t newValue);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setInt32(const TagId& tagId, std::int32_t newValue);

    /// \brief Deprecated. Use setInt32() instead.
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setSignedLong(const TagId& tagId, std::int32_t newValue);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setUint64(const TagId& tagId, std::uint64_t newValue, tagVR_t tagVR);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setUint32(const TagId& tagId, std::uint32_t newValue, tagVR_t tagVR);

    /// \brief Deprecated. Use setUint32() instead.
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setUnsignedLong(const TagId& tagId, std::uint32_t newValue, tagVR_t tagVR);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setUint64(const TagId& tagId, std::uint64_t newValue);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setUint32(const TagId& tagId, std::uint32_t newValue);

    /// \brief Deprecated. Use setUint32() instead.
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setUnsignedLong(const TagId& tagId, std::uint32_t newValue);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setInt16(const TagId& tagId, std::int16_t newValue, tagVR_t tagVR);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setInt16(const TagId& tagId, std::int16_t newValue);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setUint16(const TagId& tagId, std::uint16_t newValue, tagVR_t tagVR);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setUint16(const TagId& tagId, std::uint16_t newValue);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setInt8(const TagId& tagId, std::int8_t newValue, tagVR_t tagVR);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setInt8(const TagId& tagId, std::int8_t newValue);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setUint8(const TagId& tagId, std::uint8_t newValue, tagVR_t tagVR);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setUint8(const TagId& tagId, std::uint8_t newValue);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setDouble(const TagId& tagId, double newValue, tagVR_t tagVR);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setDouble(const TagId& tagId, double newValue);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setFloat(const TagId& tagId, float newValue, tagVR_t tagVR);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setFloat(const TagId& tagId, float newValue);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setString(const TagId& tagId, const std::string& newString, tagVR_t tagVR);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setString(const TagId& tagId, const std::string& newString);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setUnicodeString(const TagId& tagId, const std::wstring& newString, tagVR_t tagVR);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setUnicodeString(const TagId& tagId, const std::wstring& newString);
#endif
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setAge(const TagId& tagId, const Age& age);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setDate(const TagId& tagId, const Date& date, tagVR_t tagVR);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setDate(const TagId& tagId, const Date& date);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setPatientName(const TagId& tagId, const PatientName& patientName);
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////////
    DataSet& setUnicodePatientName(const TagId& tagId, const UnicodePatientName& patientName);
    ...
    /// \brief Return the list of charsets used by the dataset to convert strings
    ///        to/from unicode.
    ///
    /// \return the list of charsets used by teh dataset to convert strings to/from
    ///         unicode
    ///
    ///////////////////////////////////////////////////////////////////////////////
    charsetsList_t getCharsetsList() const;
