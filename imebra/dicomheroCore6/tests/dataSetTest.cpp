...
TEST(dataSetTest, testFragmentation)
{
    ...
    DataSet testDataSet("1.2.840.10008.1.2.4.70");
...
TEST(dataSetTest, testCreateTags)
{
    ...
    {
        Tag patientTag = testDataSet.getTagCreate(TagId(tagId_t::PatientName_0010_0010), tagVR_t::PN);
...
TEST(dataSetTest, testSequence)
{
    for(int transferSyntaxId(0); transferSyntaxId != 4; ++transferSyntaxId)
    {
        ...
        {
            DataSet sequence0 = testDataSet.appendSequenceItem(TagId(tagId_t::ReferencedPerformedProcedureStepSequence_0008_1111));
            DataSet sequence1 = testDataSet.appendSequenceItem(TagId(tagId_t::ReferencedPerformedProcedureStepSequence_0008_1111));
...
TEST(dataSetTest, emptyCharset)
{
    for(int transferSyntaxId(0); transferSyntaxId != 4; ++transferSyntaxId)
    {
        ...
        charsetsList_t emptyStringCharsetsList;
        emptyStringCharsetsList.push_back("");
        DataSet testDataSet("1.2.840.10008.1.2", emptyStringCharsetsList);
        testDataSet.setString(TagId(0x10, 0x10), "Test0");
        ...
        DataSet readDataSet = CodecFactory::load(inputReader);
        {
            ASSERT_EQ("Test0", readDataSet.getString(TagId(0x10, 0x10), 0));
            const charsetsList_t list = readDataSet.getCharsetsList();
            ASSERT_EQ(1u, list.size());
            EXPECT_EQ("ISO_IR 6", list.front());
        }
    }
}
...
TEST(dataSetTest, functionalGroupPerFrame)
{
    ...
    DataSet frame0 = testDataSet.appendSequenceItem(TagId(tagId_t::PerFrameFunctionalGroupsSequence_5200_9230));
    frame0.setDouble(TagId(tagId_t::WindowCenter_0028_1050), 100);
    frame0.setDouble(TagId(tagId_t::WindowWidth_0028_1051), 150);

    DataSet frame1 = testDataSet.appendSequenceItem(TagId(tagId_t::PerFrameFunctionalGroupsSequence_5200_9230));
    frame1.setDouble(TagId(tagId_t::WindowCenter_0028_1050), 200);
    frame1.setDouble(TagId(tagId_t::WindowWidth_0028_1051), 250);

    DataSet frame2 = testDataSet.appendSequenceItem(TagId(tagId_t::PerFrameFunctionalGroupsSequence_5200_9230));
...
TEST(dataSetTest, functionalGroupCommon)
{
    ...
    DataSet frame = testDataSet.appendSequenceItem(TagId(tagId_t::SharedFunctionalGroupsSequence_5200_9229));
