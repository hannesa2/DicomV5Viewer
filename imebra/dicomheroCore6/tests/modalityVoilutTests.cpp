...
TEST(modalityVoilut, voilutUnsigned8)
{
...

    {
        ...
        Image signed8Out = voilut.allocateOutputImage(unsigned8, 6, 1);
...
TEST(modalityVoilut, voilutUnsigned8FunctionalGroupFrame)
{
    ...
    DataSet allFrames = testDataSet.appendSequenceItem(TagId(tagId_t::SharedFunctionalGroupsSequence_5200_9229));
    ...
    DataSet lutItem = frame2.appendSequenceItem(TagId(tagId_t::ModalityLUTSequence_0028_3000));
    {
...
TEST(modalityVoilut, voilutUnsigned8LUT)
{
    ...
    DataSet testDataSet("1.2.840.10008.1.2.1");
    testDataSet.setImage(0, unsigned8, imageQuality_t::veryHigh);
    Tag sequenceTag = testDataSet.getTagCreate(TagId(tagId_t::ModalityLUTSequence_0028_3000));
