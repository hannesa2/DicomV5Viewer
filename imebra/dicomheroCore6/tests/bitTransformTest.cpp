...
TEST(bitTransformTest, allocateOutputImage)
{
    ...
    TransformHighBit transform;
    Image allocated8bits = transform.allocateOutputImage(bits8Image, 1, 1);
    Image allocated16bits = transform.allocateOutputImage(bits16Image, 1, 1);
    Image allocated4bits = transform.allocateOutputImage(bits4Image, 1, 1);
