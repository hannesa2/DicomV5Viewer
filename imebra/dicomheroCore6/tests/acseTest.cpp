    ...
    try
    {
        ...
        for(const std::string& abstractSyntax: scpAbstractSyntaxes)
        {
            ...
            for(const std::string& transferSyntax: transferSyntaxes)
            {
                ...
                dataset0
                        .setUint32(TagId(tagId_t::CommandField_0000_0100), 0x1, tagVR_t::US)
                        .setUint32(TagId(tagId_t::MessageID_0000_0110), messageId, tagVR_t::US)
                        .setString(TagId(tagId_t::StudyInstanceUID_0020_000D), "1.2.3.4.5")
                        .setUint32(TagId(tagId_t::CommandDataSetType_0000_0800), 0x101);
        ...
        for(;;)
        {
            ...
            // First send a response with a wrong ID: it should throw
            {
                ...
                responseDataSet
                        .setUint32(TagId(tagId_t::CommandField_0000_0100), 0x8001, tagVR_t::US)
                        .setUint32(TagId(tagId_t::MessageIDBeingRespondedTo_0000_0120), 0xffff, tagVR_t::US)
                        .setString(TagId(tagId_t::StudyInstanceUID_0020_000D), commandDataSet.getString(TagId(tagId_t::StudyInstanceUID_0020_000D), 0, ""))
                        .setString(TagId(tagId_t::SeriesInstanceUID_0020_000E), "1.2.3.4.5")
                        .setUint32(TagId(tagId_t::Status_0000_0900), 0x0000);
                AssociationMessage response(command.getAbstractSyntax());
            ...
            // Now send the real response
            {
                ...
                responseDataSet
                        .setUint32(TagId(tagId_t::MessageIDBeingRespondedTo_0000_0120), responseId, tagVR_t::US)
                        .setString(TagId(tagId_t::StudyInstanceUID_0020_000D), commandDataSet.getString(TagId(tagId_t::StudyInstanceUID_0020_000D), 0, ""))
                        .setString(TagId(tagId_t::SeriesInstanceUID_0020_000E), "1.2.3.4.5")
                        .setUint32(TagId(tagId_t::CommandDataSetType_0000_0800), command.hasPayload() ? 0 : 0x0101)
                        .setUint32(TagId(tagId_t::Status_0000_0900), 0x0000);
    ...
    try
    {
        ...
        for(;;)
        {
...

            {
                ...
                responseDataSet.
                        setUint32(TagId(tagId_t::MessageIDBeingRespondedTo_0000_0120), messageId, tagVR_t::US)
                        .setString(TagId(tagId_t::SeriesInstanceUID_0020_000E), "1.2.3.4.5")
                        .setUint32(TagId(tagId_t::CommandDataSetType_0000_0800), command.hasPayload() ? 0 : 0x0101)
                        .setUint32(TagId(tagId_t::Status_0000_0900), 0x0000);
...
TEST(acseTest, negotiationOneTransferSyntax)
{
    ...
    dataset0
            .setUint32(TagId(tagId_t::CommandField_0000_0100), 0x1, tagVR_t::US)
            .setUint32(TagId(tagId_t::MessageID_0000_0110), 0x1, tagVR_t::US)
            .setString(TagId(tagId_t::StudyInstanceUID_0020_000D), "1.2.3.4")
            .setUint32(TagId(tagId_t::CommandDataSetType_0000_0800), 0x101);
    command.addDataSet(dataset0);
...
TEST(acseTest, sendPayload)
{
...

    {
        ...
        for(size_t payloadSize(1); payloadSize < maxPayloadSize; payloadSize += 128)
        {
            ...
            DataSet payload(scu.getTransferSyntax("1.2.840.10008.1.1"));
            {
...
void scuThread(AssociationSCU& scu, std::uint16_t firstMessageId, size_t numberOfMessages)
{
    ...
    for(std::uint16_t messageNumber(0); messageNumber != numberOfMessages; ++messageNumber)
    {
        ...
        DataSet payload("1.2.840.10008.1.2.1");
        {
            WritingDataHandlerNumeric writing(payload.getWritingDataHandlerRaw(TagId(tagId_t::PixelData_7FE0_0010), 0, tagVR_t::OB));
            writing.setSize(payloadSize);
            size_t dummy;
