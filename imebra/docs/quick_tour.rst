...
The second method applies to the image the :cpp:class:`dicomhero::ModalityVOILUT` transform automatically if present
...
.. code-block:: c++
    ...
    dicomhero::DataSet dataSet("1.2.840.10008.1.2.1", "ISO 2022 IR 6");
...
- :cpp:member:`dicomhero::DataSet::setSignedLong`
- :cpp:member:`dicomhero::DataSet::setUnsignedLong`
- :cpp:member:`dicomhero::DataSet::setDouble`
- :cpp:member:`dicomhero::DataSet::setString`
- :cpp:member:`dicomhero::DataSet::setUnicodeString` (C++ only)
- :cpp:member:`dicomhero::DataSet::setpatientName`
- :cpp:member:`dicomhero::DataSet::setUnicodePatientName` (C++ only)
- :cpp:member:`dicomhero::DataSet::setAge`
- :cpp:member:`dicomhero::DataSet::setDate`
...
.. code-block:: c++
    ...
    dicomhero::Image image(300, 200, dicomhero::bitDepth_t::depthU16, "RGB", 15);
...
.. code-block:: c++
    ...
    dicomhero::DataSet payload(dimse.getTransferSyntax("1.2.840.10008.5.1.4.1.1.4.1")); // We will use the negotiated transfer syntax
